  ...
  return (
    <>
        ...
        <div className="card mx-auto" style={{ width: "80%", maxWidth: "600px" }}>
          <div className="card-body text-center">
            ...
            <p className="card-text">
              <strong>Category:</strong> {Womenproduct.category}
            </p>
            <p className="card-text">
              <strong>Description:</strong> {Womenproduct.description}
            </p>
            <br />
      ...
      <div className="position-relative">
        <a href="" className="brand-logo" style={{ fontSize: "150px", letterSpacing: "100px", paddingLeft: "8%", fontWeight: "500", textDecoration: "none", color: "black" }}>AETHER</a>
