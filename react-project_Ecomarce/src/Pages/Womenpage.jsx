...
import "../App.css"; // Ensure custom styles for the media queries
  ...
  return (
    ...
    <>
        ...
        >
          ...
          <Link to={"/Womenproduct"}>
            <button className="cta">
              <span className="hover-underline-animation text-light"> Shop now </span>
              <svg
                id="arrow-horizontal"
      ...
      <div className="position-relative">
        <a href="" style={{
          fontSize: "150px", letterSpacing: "100px", paddingLeft: "8%",
          fontWeight: "500", textDecoration: "none", color: "black"
        }}>
          AETHER
        </a>
